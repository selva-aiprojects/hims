                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  Text('${order['test_name']} • Priority: ${order['priority'] ?? 'Normal'}', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF475569))),
                                  Text('MRN: ${order['mrn'] ?? 'N/A'} • Ordered: ${order['created_at']?.toString().split('T')[0] ?? 'Today'}', style: const TextStyle(fontSize: 11, color: Color(0xFF64748B))),
                                ],
                              ),
                              trailing: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 9,
                                      fontWeight: FontWeight.bold,
                                      color: order['is_paid'] == true || order['is_paid'] == 1 ? Colors.green : Colors.red,
                                    ),
                                  ),
                                ],
                              ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Text('TEST SUMMARY & RESULTS', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w900, color: Color(0xFF64748B), letterSpacing: 1.2)),
                    ],
                  ),
                  if (!isMobile)
                    IconButton(
              ...
              const SizedBox(height: 4),
              Text('Patient: ${_selectedOrder['patient_name']}', style: const TextStyle(color: Color(0xFF1E293B), fontWeight: FontWeight.w700, fontSize: 14)),
              Text('MRN: ${_selectedOrder['mrn'] ?? 'N/A'} • Doc: ${_selectedOrder['doctor_name'] ?? 'Staff'}', style: const TextStyle(color: Color(0xFF64748B), fontSize: 12)),
            ],
          ),
        ),
        // Results Entry Panel
              ...
              children: [
                      ...
                      children: [
                        const Row(
                          children: [
                            ...
                            SizedBox(width: 8),
                            Text('Unpaid Lab Order', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF9F1239))),
                          ],
                        ),
                        const SizedBox(height: 6),
                        const Text('Collect billing amount (₹500) before releasing or performing the test.', style: TextStyle(fontSize: 12, color: Color(0xFF475569))),
                        ...
                        ElevatedButton(
                          ...
                          child: const Text('Checkout / Collect Payment', style: TextStyle(fontWeight: FontWeight.bold)),
                        ),
                      ],
                    ),
                  ),
                ...
                if (_selectedOrder['status'] == 'Pending') ...[
                  ...
                  Container(
                    ...
                    child: const Column(
                      children: [
                        Icon(Icons.check_circle_outline, color: Color(0xFF2563EB), size: 32),
                        SizedBox(height: 8),
                        Text('Report Published & Complete', style: TextStyle(color: Color(0xFF1D4ED8), fontWeight: FontWeight.bold)),
                        SizedBox(height: 4),
                        Text('Shared to Patient timeline.', style: TextStyle(fontSize: 12, color: Color(0xFF60A5FA))),
                      ],
                    ),
                  ),
                ],
        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Row(
                children: [
                  Icon(Icons.biotech, color: Color(0xFF4F46E5), size: 14),
                  SizedBox(width: 4),
                  Text(
                    'LABORATORY',
                    style: TextStyle(
