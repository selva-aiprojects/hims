                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              leading: CircleAvatar(
                                backgroundColor: p['status'] == 'Completed' ? const Color(0xFFD1FAE5) : const Color(0xFFFEE2E2),
                                child: Icon(
                                  Icons.assignment,
                                  color: p['status'] == 'Completed' ? const Color(0xFF059669) : const Color(0xFFEF4444),
                                ),
                              ),
                              title: Text(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  Text('MRN: ${p['mrn'] ?? 'N/A'} • Rx ID: ${p['id'].toString().substring(0, 8)}', style: const TextStyle(fontSize: 12, color: Color(0xFF64748B))),
                                  Text('Prescribed by ${p['doctor_name'] ?? 'Physician'}', style: const TextStyle(fontSize: 12, color: Color(0xFF94A3B8))),
                                ],
                              ),
                              trailing: Container(
                                padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                                decoration: BoxDecoration(
                                  color: p['status'] == 'Completed' ? const Color(0xFFD1FAE5) : const Color(0xFFFFE4E6),
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    color: p['status'] == 'Completed' ? const Color(0xFF065F46) : const Color(0xFF9F1239),
                                  ),
                                ),
                              ),
                            ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Text('PRESCRIPTION DETAILS', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w900, color: Color(0xFF64748B), letterSpacing: 1.2)),
                    ],
                  ),
                  if (!isMobile)
                    IconButton(
              ...
              Text('MRN: ${_selectedPrescription['mrn'] ?? 'N/A'}', style: const TextStyle(color: Color(0xFF64748B), fontSize: 13)),
            ],
          ),
        ),
        // Items List
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              _buildBadge(Icons.speed, item['frequency'] ?? 'Twice daily'),
                            ],
                          ),
            ...
            child: Column(
              ...
              children: [
                ...
                OutlinedButton.icon(
                  ...
                  icon: const Icon(Icons.receipt_long, color: Color(0xFF059669)),
        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Row(
                children: [
                  Icon(Icons.local_pharmacy_rounded, color: Color(0xFF059669), size: 14),
                  SizedBox(width: 4),
                  Text(
                    'PHARMACY',
                    style: TextStyle(
