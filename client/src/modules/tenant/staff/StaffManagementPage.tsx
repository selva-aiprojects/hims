...
export default function StaffManagementPage() {
  ...
  const fetchDepartments = async () => {
    try {
      ...
      // fallback to sensible defaults if departments master isn't seeded yet
      setDepartments(['General Medicine', 'Cardiology', 'Dermatology', 'ENT', 'Gastroenterology',
        ...
        'ICU', 'Emergency', 'Pharmacy', 'Laboratory', 'Radiology', 'Administration']);
    }
  };
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '16px' }}>
                  ...
                  <div>
                    ...
                    <input type="number" style={{ width: '100%', padding: '12px', borderRadius: '12px', border: '1px solid #e2e8f0', background: '#f8fafc' }}
