...
export default function OPDConsultationPage() {
  ...
  const printPrescription = () => {
    ...
    const htmlContent = `
      ...
      <div class="header"><div><div class="hospital-title">${localStorage.getItem("tenantName") || "HEALTHEZEE CLINICS"}</div><div class="hospital-sub">Integrated Health Management System</div></div>
