                ...
                <tbody>
                  {claims.map((c, i) => (
                    <tr key={i} style={{ borderBottom: '1px solid #f1f5f9' }}>
                      ...
                      <td style={{ padding: '20px 24px' }}>
                        <p style={{ margin: 0, fontWeight: 700 }}>₹{Number(c.billed_amount).toLocaleString()}</p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '32px' }}>
             <div style={{ background: 'white', padding: '32px', borderRadius: '28px', border: '1px solid #e2e8f0', height: 'fit-content' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  {providers.map((p, i) => (
                    <div key={i} style={{ padding: '16px', borderRadius: '16px', background: '#f8fafc', border: '1px solid #f1f5f9' }}>
                    ...
                    <div key={i} style={{ padding: '20px', borderRadius: '20px', border: '1px solid #e2e8f0', background: 'white', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
                       ...
                       <div style={{ marginTop: '16px', display: 'flex', justifyContent: 'space-between' }}>
                          <div>
                            ...
                            <p style={{ margin: 0, fontWeight: 800 }}>₹{Number(p.base_coverage).toLocaleString()}</p>
                          </div>
                      ...
                      <tr key={i} style={{ borderBottom: '1px solid #f1f5f9' }}>
                         ...
                         <td style={{ padding: '20px 24px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                               ...
                               <span style={{ fontSize: '12px', fontWeight: 800 }}>₹{Number(m.remaining_limit).toLocaleString()} / ₹{Number(m.total_limit).toLocaleString()}</span>
                            </div>
                         </td>
                         <td style={{ padding: '20px 24px' }}>
