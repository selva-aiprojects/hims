...
export default function ClinicalAnalyticsDashboard() {
  ...
  if (loading) return <div style={{ display: 'grid', placeItems: 'center', height: '100vh', background: '#f8fafc', fontSize: '18px', fontWeight: 800, color: '#4f46e5' }}>Synchronizing Live Clinical Intelligence...</div>;
...
const AlertItem = ({ type, title, desc, time }: any) => {
   ...
   return (
      <div style={{ display: 'flex', gap: '16px', padding: '16px', borderRadius: '16px', background: '#f8fafc' }}>
