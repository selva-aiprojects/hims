...
export default function Consultation() {
  const [patientId, setPatientId] = useState("P-10024");
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <section style={{ background: 'white', padding: '32px', borderRadius: '24px', border: '1px solid #e2e8f0' }}>
              ...
              <textarea 
                ...
                style={{ width: '100%', height: '200px', padding: '20px', borderRadius: '16px', border: '1px solid #e2e8f0', background: '#f8fafc', outline: 'none', fontSize: '15px', lineHeight: '1.6' }}
              />
            </section>
          </div>
          ...
          <aside style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            <section style={{ background: 'white', padding: '32px', borderRadius: '24px', border: '1px solid #e2e8f0' }}>
              ...
              <input 
                ...
                style={{ width: '100%', padding: '12px', borderRadius: '12px', border: '1px solid #e2e8f0', background: '#f8fafc', outline: 'none', marginBottom: '24px' }}
              />
              <button 
                onClick={submit}
                disabled={loading}
              ...
              >
                {loading ? "Saving..." : <><Icons.Check /> Finish & Bill</>}
              </button>
            </section>
          </aside>
        </div>
