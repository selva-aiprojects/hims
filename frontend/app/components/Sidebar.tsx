  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-logo">
        ...
        <h3 style={{ fontSize: '20px', fontWeight: 700 }}>healthezee</h3>
      </div>

      <nav className="nav-section">
        <a href="/tenant/dashboard" className={`nav-item ${currentPath === '/tenant/dashboard' ? 'active' : ''}`}>
          <Icons.Dashboard />
          <span>Dashboard</span>
        </a>
        <a href="/consultation" className={`nav-item ${currentPath === '/consultation' ? 'active' : ''}`}>
          <Icons.Consultation />
          <span>Consultation</span>
        </a>
        <a href="/appointments" className={`nav-item ${currentPath === '/appointments' ? 'active' : ''}`}>
          <Icons.Appointments />
          <span>Appointments</span>
        </a>
        <a href="/billing" className={`nav-item ${currentPath === '/billing' ? 'active' : ''}`}>
          <Icons.Billing />
          <span>Billing</span>
        </a>
